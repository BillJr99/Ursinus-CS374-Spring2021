...
info: 
  ...
  models:
    - model: |
        ...
        <thead>
          <tr>
            <th class="tg-c3ow"><span style="background-color:#EAECF0">Grammar</span></th>
            <th class="tg-c3ow"><span style="background-color:#EAECF0">Languages</span></th>
            <th class="tg-c3ow"><span style="background-color:#EAECF0">Automaton</span></th>
            <th class="tg-c3ow"><span style="background-color:#EAECF0">Production rules (constraints)*</span></th>
            <th class="tg-c3ow"><span style="background-color:#EAECF0">Examples</span><a href="https://en.wikipedia.org/wiki/Chomsky_hierarchy#cite_note-3"><span style="text-decoration:none;color:#0B0080;background-color:initial">[3]</span></a></th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td class="tg-0pky">Type-0</td>
            ...
            <td class="tg-0pky">{\displaystyle \gamma \rightarrow \alpha }<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/902fc01e3f2cc85935e36efe834b543eb6b19d5b" alt="{\displaystyle \gamma \rightarrow \alpha }" width="46" height="17"><br>(no constraints)</td>
            <td class="tg-0pky">{\displaystyle L=\{w|w}<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/46f75a36ee91fb70c39b78145c087df4abdb1035" alt="{\displaystyle L=\{w|w}" width="71" height="21"># describes a terminating Turing machine{\displaystyle \}}<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/2cf208e5d370391e66767f13641bd5ee6ad93825" alt="\}" width="8" height="21"></td>
          </tr>
          <tr>
            ...
            <td class="tg-0pky">{\displaystyle \alpha A\beta \rightarrow \alpha \gamma \beta }<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/1173552bcbf68bb06baf9b0a2f543dbc845caefd" alt="\alpha A \beta \rightarrow \alpha \gamma \beta" width="89" height="19"></td>
            <td class="tg-0pky">{\displaystyle L=\{a^{n}b^{n}c^{n}|n&gt;0\}}<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/2bb63b71ffcba840f36e802aafe4c9951cf9ec38" alt="{\displaystyle L=\{a^{n}b^{n}c^{n}|n>0\}}" width="147" height="21"></td>
          </tr>
          <tr>
            ...
            <td class="tg-0pky">{\displaystyle A\rightarrow \alpha }<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/13dc432701b1477bc9ba32b0d71c58ecf2d44d9e" alt="{\displaystyle A\rightarrow \alpha }" width="50" height="16"></td>
            <td class="tg-0pky">{\displaystyle L=\{a^{n}b^{n}|n&gt;0\}}<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/dfafe0fa14e5249f492f5cbde42062ba4904d56f" alt="{\displaystyle L=\{a^{n}b^{n}|n>0\}}" width="130" height="21"></td>
          </tr>
          <tr>
            <td class="tg-0pky">Type-3</td>
            ...
            <td class="tg-0pky">{\displaystyle A\rightarrow {\text{a}}}<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/c5a21ff7c854fa27daf7ab3882590f938e5720e9" alt="{\displaystyle A\rightarrow {\text{a}}}" width="47" height="16"><br>and<br>{\displaystyle A\rightarrow {\text{a}}B}<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/8a487d4dba9e9959ea3a34e06b5e5677c8eff4d4" alt="{\displaystyle A\rightarrow {\text{a}}B}" width="60" height="16"></td>
            <td class="tg-0pky">{\displaystyle L=\{a^{n}|n\geq 0\}}<img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/2d8085f37ec7d2aa499b0d27008c940279088d09" alt="{\displaystyle L=\{a^{n}|n\geq 0\}}" width="114" height="21"></td>
          </tr>
        </tbody>
        </table>
