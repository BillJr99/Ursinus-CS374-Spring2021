...
info:
  ...
  banner: |
    ...
    <div style="width: 100%; display: table-row;">
        ...
        <div style="display: table-cell; padding:5px; width:33%;">
            <a title="DevinCook at English Wikipedia, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Parser_Flow%D5%B8.gif"><img height="100" style="display:block;" alt="Parser Flow" src="https://upload.wikimedia.org/wikipedia/commons/d/d6/Parser_Flow%D5%B8.gif"></a>
        </div>
        <div style="display: table-cell; padding:5px; width:33%;">
