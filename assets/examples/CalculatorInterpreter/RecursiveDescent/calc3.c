...
int term2(void) {
    ...
    int value = 1; // the identity in case we have null (semantics)
...
int term(void) {
    ...
    // we have left simplified, but the grammar is effectively the same thanks to the if statement that was here.
    value *= term2();  
...
int expr2() {
    ...
    int value = 0; // identity in case we have null (semantics)
